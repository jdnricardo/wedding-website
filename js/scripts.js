$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Mari and Julian's Wedding",

            // Event start date
            start: new Date('Sept 5, 2024 4:00'),
            ...
            end: new Date('Sept 6, 2024 00:00'),

            // Event Address
            address: '452 Mountain Road, Goffstown, NH 03045',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues, please contact Julian."
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 42.9859684, lng: -71.36};
...
function initBBSRMap() {
    var la_fiesta = {lat: 42.9859684, lng: -71.36};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
